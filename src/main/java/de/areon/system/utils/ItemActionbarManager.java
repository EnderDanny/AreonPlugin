...
public class ItemActionbarManager {
    ...
    public static ItemStack addLoreEntchant(String Display, Material mat, String lores, int Anzahl, Enchantment enchantment, int enchantmentID) {
        ItemStack is = new ItemStack(mat, Anzahl);
        ItemMeta im = is.getItemMeta();
        im.setDisplayName(Display);
        List<String> lore = new ArrayList<>();
    ...
    public static ItemStack createSkull(String Anzeigename, String Owner){
        ItemStack i = new ItemStack(Material.SKULL_ITEM, 1, (byte) 3);
        SkullMeta m = (SkullMeta) i.getItemMeta();
        m.setOwner(Owner);
        m.setDisplayName(Anzeigename);
        i.setItemMeta(m);
